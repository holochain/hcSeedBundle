export type UnlockType = {
  type: "pwHash" | "securityQuestions";
  passphrase?: string;
  questionList?: string[];
  answerList?: string[];
};

export type DerivationsType = Record<string, string>;
...
export type SeedBundleTestFixtures = {
  success: SuccessType[];
};

const seedBundleTestFixtures: SeedBundleTestFixtures = {
  success: [
    {
      desc: "two-pass-generated-by-javascript",
      cipher:
        "k6VoY3NiMJKWonB3xBDsEEGX8xbw7lBOyJQGFgPLzSAAAcQYU1CZvyjFB6PQJsShIUm8i-EScti04acYxDGVBvUz_87xdqZDb3RubrJ1YBVQDDmr0z3_Bf07O0PgJ2Bg08KD8gpIpirSt3fKueVolqJwd8QQSuaipI0rXCtalErGLAWFGs0gAAHEGMfI7d3qTDyvGy0VUwUpDRuydUEHIH2WEMQxrlEtQbRHniKmNfdm0c9v11ZZRkZPIx1kE28il57A6vE0uE7kfUiCwIW0y0dhlPeqzMQBgA",
      unlock: [
        {
          type: "pwHash",
          passphrase: "zombies1",
    ...
    },
    {
      ...
      cipher:
        "k6VoY3NiMJKWonB3xBC70Y5v4B4DEJ6bZY9ZNeCvzSAAAcQYVQbypAbwQxJMMEYAiKvt9_PbGFCE3nHyxDFlLv9ib9WeDW0wjZFPFtaFW_js2RBfUt34b-MfeUnQ1ZZfe1CAdSZVFuQ_7c8CXp_FlqJwd8QQ2Lf-b-ufVr-1_3heZcDKZc0gAAHEGM7lURX1C40gdwPo_-KIyQCWq8_MVh74SMQxKui_9Aqo_3v8dmDYxdPEe1qHvyguQDuXxxBbLDMoMjzteTTnG_z2SWptfrjQHd6sNcQA",
      unlock: [
        {
          type: "pwHash",
    ...
    },
    {
      ...
      cipher:
        "k6VoY3NiMJKWonB3xBCaTAWCGW9TjLxw4U6jkc-YzSAAAcQYY-56t-6zerft5QuI-G9Z2V8Crd6xIO_pxDHSENNDFJLpCbPE6l64-_RZdSbaAB2EdvwRiZoWONH_o3qgCtCmjfyWPNiKQQpdiyJRmaJxYcQQci5Iy9v5sj1mSOw6MYIV1M0gAAGvRmF2b3JpdGUgQ29sb3I_qkZpcnN0IFBldD-lSGFpcj_EGFGah7pMTe-Iazc5F-jmIvFiPm1TJgZwAsQxv4nlOpAseeZ7b2dcTriyx9AHqwVcRYoM0r2H72jmDYKnac4VApjl1TgUywR_yqX5NcQA",
      unlock: [
        {
          type: "pwHash",
          passphrase: "my passphrase with multiple words",
...
export default seedBundleTestFixtures;
